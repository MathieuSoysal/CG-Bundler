...
impl CargoProject {
    ...
    fn analyze_targets(package: &Package) -> Result<(Target, Option<Target>)> {
        ...
        // Find binary targets
        let binary_targets: Vec<_> = targets.iter()
        ...
        let library_targets: Vec<_> = targets.iter()
    ...
    fn determine_base_path(library_target: &Option<Target>, binary_target: &Target) -> Result<PathBuf> {
